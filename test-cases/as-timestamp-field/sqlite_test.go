...
func sqliteAsTimestampComponentUnderTest(t *testing.T) as_timestamp_field.AsTimestampRepository {
	...
	repo, err := as_timestamp_field.NewSQLiteAsTimestampRepository(db)
	if err != nil {
