...
import (
	...
	"github.com/samlitowitz/protoc-gen-crud/options/github.com/samlitowitz/protoc-gen-crud/options"
...
type Registry struct {
	...
	fileOptions map[string]*options.FileOptions
	...
	messageOptions map[string]*options.MessageOptions
	...
	// field name
	fieldOptions map[string]*options.FieldOptions
}
